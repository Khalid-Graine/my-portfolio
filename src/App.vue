<template>
  <div class="font-Poppins flex flex-col overflow-hidden text-primary">
    <!-- part 1 -->
    <div
      class="pt-10 lg:w-6/12 lg:h-screen lg:py-20 lg:fixed top-0 left-0 padding bg-main"
    >
      <homePart
        :currentPart="currentPart"
        :info="InfoStore"
        @valueEmitted="handleValueFromChild"
      ></homePart>
    </div>

    <!-- part 2 -->
    <main
      class="lg:w-6/12 lg:absolute top-0 right-0 padding flex flex-col gap-20 bg-main"
    >
      <!-- ab -->
