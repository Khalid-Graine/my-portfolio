<template>
    <div class="bg-main font-Poppins">
        <div class="w-8/12 mx-auto py-20 text-primary">
        ...
        <table class="min-w-full text-left text-sm font-light">
          <thead class="border-b font-bold dark:border-neutral-500">
            <tr>
              ...
              <th scope="col" class="px-6 py-4">Build with</th>
          ...
          <tbody>  
            <tr v-for="project in InfoStore.projects" :key="project"
              ...
              <td class="whitespace-nowrap px-6 py-2">
                    ...
                    <div class="w-[150px] overflow-hidden bg-red-400">
              ...
              <td class="whitespace-nowrap px-6 py-2 h-full">
